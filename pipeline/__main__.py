"""python -m pipeline {audit|extract|cluster|consolidate|verify|render|serve|all|lock|unlock} [--pages 1-5] [--force]"""

import argparse
import sys

from . import audit, cluster, consolidate, crypto, extract, render, verify


def main() -> None:
    sys.stdout.reconfigure(encoding="utf-8")
    parser = argparse.ArgumentParser(prog="python -m pipeline")
    parser.add_argument("step", choices=["audit", "extract", "cluster", "consolidate", "verify", "render", "serve", "all", "lock", "unlock"])
